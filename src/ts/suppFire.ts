...
function suppressiveFire(weapon: any): object {
    const suppressiveFire = {
      displayText: `Everyone on foot within 25 m/yds, out of cover, and in your line of sight must roll ${bold("WILL + Concentration + 1d10")} against your Skill Check result above.\n
